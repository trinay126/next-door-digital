/* ================================================================
   Next Door Digital — main client-side script
   ================================================================ */
...
function handleBooking(e) {
  ...
  fetch('/api/booking', {
    ...
    .catch(() => {
      ...
      openDemo(`mailto:nextdoordigitalndd@gmail.com?subject=${subject}&body=${body}`);
...
function handleContact(e) {
  ...
  fetch('/api/contact', {
    ...
    .catch(() => {
      ...
      const mailSubject = encodeURIComponent(`[Next Door Digital Contact] ${subject}`);
      const mailBody    = encodeURIComponent(
        `Name: ${name}\nEmail: ${email}\n${planLine}Subject: ${subject}\n\nMessage:\n${message}`
      );
      openDemo(`mailto:nextdoordigitalndd@gmail.com?subject=${mailSubject}&body=${mailBody}`);
...
function toggleTheme() {
  ...
  localStorage.setItem('nextdoor-theme', isLight ? 'light' : 'dark');
...
(function () {
  if (localStorage.getItem('nextdoor-theme') === 'light') {
